...
public class MyApplication {
    ...
    public static void main(String[] args) {
    	...
    	hotelService.addCity(BigInteger.valueOf(6),"Mumbai");

		hotelService.addCity(BigInteger.valueOf(7),"Pune");
		
		System.out.println(hotelService.showCity());
		System.out.println(hotelService.showHotel(BigInteger.valueOf(2)));
